...
```{r max horse table, message=FALSE, label='Max and min number of horses for each province (1940-72)'}
...
```{r plot province, fig.width=5, fig.height=4, fig.cap='Figure.2 Number of horses for province of choice', out.width='50%'}
