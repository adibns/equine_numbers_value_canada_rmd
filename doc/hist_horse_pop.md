...
The R programming language and the following R (R Core Team 2020)
...
<img src="hist_horse_pop_files/figure-gfm/plot horses-1.png" alt="Figure.1 Horse Population for all provinces in Canada between 1940 - 1972." width="100%" />

<p class="caption">

Figure.1 Horse Population for all provinces in Canada between 1940 -
1972.
...
<img src="hist_horse_pop_files/figure-gfm/plot province-1.png" alt="Figure.2 Number of horses for province of choice" width="50%" />

<p class="caption">

Figure.2 Number of horses for province of choice
